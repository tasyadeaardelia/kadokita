...
@section('title', 'Tulis Blog Baru - Admin')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-10">
                <h1 class="h3 mb-2 text-gray-900">Tulis Blog</h1>
            </div>
            <div class="col-2">
                ...
                <form method="post" enctype='multipart/form-data' action="{{ route('post.store')}} ">
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="publishedAt" type="datetime-local" value="" id="example-datetime-local-input">
                            </div>
                        </div>
                        <div class="form-group row">
